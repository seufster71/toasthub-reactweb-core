	...
	return (
		<div className="col-xs-12 col-md-2 col-md-offset-4">
        	<div className="input-group">
        		<input className="form-control" type="text" id={name+'_input'} name={name+'_input'} placeholder={placeHolder} aria-label="Search" onChange={onChange(name+'_input')} onBlur={onBlur}/>
